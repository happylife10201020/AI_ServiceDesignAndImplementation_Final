...
| 파일 | 역할 |
|---|---|
| `main.py` | 엔트리포인트(대화 루프 / `--rebuild-index` / `--diagram`) |
...
Python 3.14 + langchain 1.3 / langgraph 1.2 / chromadb 1.5에서 검증.
...
지식원: `day10/RAG.pdf`, `day11/LangGraph.pdf`, `day13/Agent.pdf`, 과제 공지 PDF.
